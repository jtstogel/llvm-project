...
#ifndef _LIBCPP___LOCALE_DIR_SUPPORT_NO_LOCALE_ENCODING_H
#define _LIBCPP___LOCALE_DIR_SUPPORT_NO_LOCALE_ENCODING_H
...
inline _LIBCPP_HIDE_FROM_ABI wint_t __btowc(int __ch, __locale_t) { return std::btowc(__ch); }

inline _LIBCPP_HIDE_FROM_ABI int __wctob(wint_t __ch, __locale_t) { return std::wctob(__ch); }
...
inline _LIBCPP_HIDE_FROM_ABI size_t __wcrtomb(char* __s, wchar_t __ch, mbstate_t* __ps, __locale_t) {
...
inline _LIBCPP_HIDE_FROM_ABI size_t __mbrtowc(wchar_t* __pwc, const char* __s, size_t __n, mbstate_t* __ps, __locale_t) {
...
#endif // _LIBCPP___LOCALE_DIR_SUPPORT_NO_LOCALE_ENCODING_H
